...
3.	Define a base class Customer with attributes customerId, name, and purchaseWeight.
4.	Define RegularCustomer subclass with a 2% discount on the gold rate.
5.	Define PremiumCustomer subclass with a 5% discount and 1% cashback on the final price.
6.	Input the base gold rate per gram at runtime.
7.	For each customer, calculate and display the final price (and cashback for premium).
...
<img width="1290" height="746" alt="image" src="https://github.com/user-attachments/assets/181039a1-3387-4190-abcb-0827c12cdcd8" />
